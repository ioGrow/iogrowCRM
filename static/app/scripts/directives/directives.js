        ...
        var elmnt=$(element);
          switch(item.type) {
            case 'Case':
                ...
                break;
            case 'Contact':
                 el='<div class="item-content"><div class="pic"><img src="/static/img/avatar_contact.jpg" ></div><div class="text"><ul class="list-group linkedinItemDetails"><li class="likedinItemName"><a href="/#/contacts/show/'+item.id+'">'+item.title+'</a></li><!--<li class="likedinItemType">Customer Development &amp; Secret History, Teaching </li><li class="likedinItemAddress"><i class="fa fa-building"></i>Stanford, Berkeley and Columbia</li>--><li class="likedinType"><span class="pull-right">Contact</span></li></ul></div><div class="clearfix"></div></div>'; 
                $(elmnt).append(el); 
                break;
            case 'Lead':
                 el='<div class="item-content"><div class="pic"><img src="/static/img/avatar_contact.jpg" ></div><div class="text"><ul class="list-group linkedinItemDetails"><li class="likedinItemName"><a href="/#/leads/show/'+item.id+'">'+item.title+'</a></li><!--<li class="likedinItemType">Customer Development &amp; Secret History, Teaching </li><li class="likedinItemAddress"><i class="fa fa-building"></i>Stanford, Berkeley and Columbia</li>--><li class="likedinType"><span class="pull-right">Lead</span></li></ul></div><div class="clearfix"></div></div>'; 
                $(elmnt).append(el); 
                break;
            case 'Account':
                el='  <li class="linkedinListItem" ><div class="pic" ><img src="/static/img/default_company.png"></div><div class="text" ><ul class="list-group linkedinItemDetails" ><li class="likedinItemName" ><a href="/#/accounts/show/'+item.id+'">'+item.title+'</a></li><!--<li class="likedinItemType" >Logiciels informatiques</li><li class="likedinItemAddress" ><i class="fa fa-map-marker" ></i>Région de Seattle , États-Unis+ de 10 000 employés</li>--><li class="likedinType" ><span class="pull-right">Account</span></li></ul></div><div class="clearfix"></div></li>'
                $(elmnt).append(el);
                break;
            case 'Task':

app.controller('ProductListCtrl', ['$scope','$route','$location','Conf','Product','Account',
    function($scope,$route,$location,Conf,Product,Account) {
...
app.controller('RoadMapShowCtrl', ['$scope','$route','$location','Conf','MultiAccountLoader','Account',
...
app.controller('RoadMapListCtrl', ['$scope','$route','$location','Conf','MultiAccountLoader','Account',
    function($scope,$route,$location,Conf,MultiAccountLoader,Account) {
     console.log('i am in account list controller');

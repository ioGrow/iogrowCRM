     ...
     $scope.listNextPageItems = function(){
        ...
        var params = {};
          if ($scope.pages[nextPage]){
            ...
            params = {'limit':7,'type_show':'Customer_Story','order':$scope.order}
          }
   ...
   // hKA 02.01.2014 Quick filter text area
    var searchParams ={};
     ...
     $scope.$watch('searchQuery', function() {
         ...
         Show.searchcustomerstories($scope,searchParams);
       };
     });

     $scope.selectResult = function(){
          window.location.replace('#/live/customer_stories/customer_story/'+$scope.searchQuery.id);
     };
    ...
    $scope.executeSearch = function(searchQuery){
        if (typeof(searchQuery)=='string'){
          ...
          window.location.replace('#/live/customer_stories/customer_story/'+searchQuery.id);
        }
        $scope.searchQuery=' ';
        $scope.$apply();
     };
...
app.controller('CustomerStoriesShowCtrl', ['$scope','$filter', '$route','Auth','Show', 'Topic','Note','Task','Event','WhoHasAccess','User','Leadstatus','Lead','Permission','Attachement','Feedback',
    ...
    //HKA 22.12.2013 Var topic to manage Next & Prev
     ...
     // What to do after authentication
     $scope.runTheProcess = function(){
          var params = {'id':$route.current.params.customerstoryId};
...
$scope.deleteshow = function(){
 console.log($scope.show.id);
  var customerstoryid = {'id':$route.current.params.customerstoryId};
 
  Show.delete($scope,customerstoryid);
  window.location.replace('#/live/customer_stories');

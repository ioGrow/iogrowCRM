app.controller('CompanyProfileListCtrl', ['$scope','$filter','Auth','Show',
...
app.controller('CompanyProfileShowCtrl', ['$scope','$filter', '$route','Auth','Show', 'Topic','Note','Task','Event','WhoHasAccess','User',

...
Default_Opp_Stages = [{'name':'Open','probability':'5%'},{'name':'Open','probability':'100%'}]
Default_Case_Status =[{'status':'Open'},{'status':'Close'}]
Default_Lead_Status =[{'status':'Open'},{'status':'Close'}]

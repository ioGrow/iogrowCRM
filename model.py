...
class Companyprofile(EndpointsModel):
  _message_fields_schema = ('id','entityKey','name','tagline','introduction','organization','organizationid','phones','emails','addresses','websites','sociallinks','youtube_channel')
